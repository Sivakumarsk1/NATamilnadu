...
import 'package:natamilnaduproject/Screening%20to%20Brief%20Intervention/screeningpage.dart';

class Screeningbrief extends StatefulWidget {
  const Screeningbrief({super.key});

  @override
  State<Screeningbrief> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<Screeningbrief> {
  bool isExpanded = false; // To toggle the visibility of the details
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.pushReplacement(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          QuizPage()), // Navigate to RegisterPage
                );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text("Screening to Brief Intervention \n(S2BI)"),
          centerTitle: true,
